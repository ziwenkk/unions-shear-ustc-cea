...
from unions_wl.example import classes, hello, math
...
class ClassesTestCase(TestCase):
    ...
    def test_luminosity(self):
        """Test ``unions_wl.example.classes.StefBoltz.luminosity`` method.

        See Also
        --------
        unions_wl.example.classes.StefBoltz : Implementation of the
            ``StefBoltz`` class.
...
class HelloTestCase(TestCase):
    ...
    def test_hello_world(self):
        """Test ``unions_wl.example.hello.hello_world`` function.

        See Also
        --------
        unions_wl.example.hello.hello_world : Implementation of the
...
class MathTestCase(TestCase):
    ...
    def test_add_two_ints(self):
        """Test ``unions_wl.example.math.add_two_ints`` function.

        See Also
        --------
        unions_wl.example.math.test_add_two_ints : Implementation of the
    ...
    def test_drake_equation(self):
        """Test ``unions_wl.example.math.drake_equation`` function.

        See Also
        --------
        unions_wl.example.math.drake_equation : Implementation of the
    ...
    def test_mad(self):
        """Test ``unions_wl.example.math.mad`` function.

        See Also
        --------
        unions_wl.example.math.mad : Implementation of the
            ``mad`` function.
