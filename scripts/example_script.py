...
from unions_wl.example.classes import StefBoltz
from unions_wl.example.hello import hello_world
...
def call_stefboltz(radius: float, eff_temp: float):
    ...
    See Also
    --------
    unions_wl.example.classes.StefBoltz : Implementation of the ``StefBoltz``
        class.
